...
def menu(user_id):  # menu function
    ...
    panel_catalog_movie = function.panel_window(window_menu, 1200, 830, 250, 20)        #main page panel displaying all the movies, series, etc.
    ...
    for i in range(1,len(lines)):
        ...
        btn.append(function.button_img(panel_catalog_movie, poster[i-1], lambda: interface_movie.movie_interface(user_id, id_movie[i-1]), image_dimentions[0], image_dimentions[1], 10+(200*((i-1)%5)), 10+(200*((i-1)//5))))
